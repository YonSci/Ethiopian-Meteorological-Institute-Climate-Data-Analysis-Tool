...
def annual_rainfall():
    ...
    if plot_type == 'Annual Total Rainfall':
        ...
        st.markdown("#### :blue[Upload annual rainfall NetCDF File]" )
        ...
        st.markdown("#### :blue[Display Annual Rainfall]" )  
        if ds is not None:
            if st.checkbox("Plot Annual Rainfall Data", key="_display"):
                ...
                # Add a title
                ax.set_title(f'Annual {variable} amount during {year}', fontsize=20, y=1.01, fontname=title_font)
        ...
        # elif plot_type == 'Departure of Annual Total Rainfall':
        #     st.write('Departure of Annual Total Rainfall')
      
            
    if plot_type == 'Annual Percent of Normal Rainfall':
        ...
        st.markdown("#### :blue[Upload annual long term mean rainfall NetCDF File]" )
        uploaded_file = st.file_uploader("Choose a NetCDF file", 
        ...
        st.markdown("#### :blue[Upload annual long term Std deviation rainfall NetCDF File]" )
        uploaded_file = st.file_uploader("Choose a NetCDF file", 
        ...
        # Read the uploaded file
            ...
            if ds and ds_mean and ds_std is not None:
                if st.checkbox("Plot Percent of Normal Rainfall Data", key="_display"):
                    ...
                    ax.set_title(f'Percent of Normal Rainfall during {year}', fontsize=20, y=1.01, fontname=title_font)
    ...
    if plot_type == 'Departure of Annual Total Rainfall':
        if variable_type == 'Rainfall':
            variable = 'Total Rainfall'
        ...
        # Read the uploaded file
            ...
            st.markdown("#### :blue[Display Departure of Annual Rainfall ]" )  
            if ds is not None:
                if st.checkbox("Plot Departure of Annual Rainfall", key="_display"):
                    fig, ax = plt.subplots(figsize=(12, 8), 
                                            subplot_kw={'projection': ccrs.PlateCarree()},
                                            #facecolor=bg_color,
                                            edgecolor='black')
                    ...
                    # Add a title
                    ax.set_title(f'Annual {variable} of {year} minus from previous year', fontsize=20, y=1.01, fontname=title_font)
