...
def monthly_average_temperature():
    ...
    if plot_type == 'Departure of monthly average temperature':
        ...
        st.markdown("#### :blue[Upload monthly average temperature NetCDF File]" )
        ...
        # Read the uploaded file
            ...
            st.markdown("#### :blue[Display monthly departure average temperature from normal]" )  
            if f is not None:
                if st.checkbox("Plot monthly departure average temperature from normal", key="_display"):
                    ...
                    # Add a title
                    ax.set_title(f' Departure of {month} average temperature from normal', fontsize=20, y=1.01, fontname=title_font)
